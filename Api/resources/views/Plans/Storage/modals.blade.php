<div id="create-storage-plan" class="modal fade">
    <div class="modal-dialog">
        <form class="modal-content" method="POST" action="{{route('plans.store')}}">
            @csrf
            <div class="modal-header bg-warning">
                <h5 class="modal-title">Create new storage plan</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <input type="hidden" value="Storage plans" name="name">
                ...
                <div class="input-group mb-3 input_quantity">
                    <input type="number" class="form-control" step="0.1" placeholder="Size of plan (GB)" name="quantity">
...
<div id="update-storage-plan-{{$plan->id}}" class="modal fade">
    <div class="modal-dialog">
        <form class="modal-content" method="POST" action="{{route('plans.update', $plan->id)}}">
            @csrf
            @method('PATCH')
            <div class="modal-header bg-warning">
                <h5 class="modal-title">Update a storage plan</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="input-group mb-3">
                ...
                <div class="input-group mb-3 input_quantity">
                    <input type="number" class="form-control" step="0.1" placeholder="Size of plan (GB)" name="quantity" value="{{$plan->quantity}}">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <i class="fas fa-hdd"></i>
                        </div>
...
<div id="delete-storage-plan-{{$plan->id}}" class="modal fade">
    <div class="modal-dialog">
        <form class="modal-content bg-danger" method="POST" action="{{route('plans.delete', $plan->id)}}" >
            ...
            <div class="modal-body ">
                <p>You're about to delete a storage plan.</p>
            </div>
