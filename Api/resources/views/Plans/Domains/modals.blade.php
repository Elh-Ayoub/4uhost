...
<div id="update-domains-plan-{{$plan->id}}" class="modal fade">
    <div class="modal-dialog">
        <form class="modal-content" method="POST" action="{{route('plans.update', $plan->id)}}">
            @csrf
            @method('PATCH')
            <div class="modal-header bg-warning">
                <h5 class="modal-title">Update domains plan</h5>
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3 input_quantity">
                    <input type="number" class="form-control" step="1" placeholder="Number of domains" name="quantity" value="{{$plan->quantity}}">
